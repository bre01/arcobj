...
namespace EX3
{
    ...
    /// </summary>
    [Guid("8545370f-b35f-4fe7-8451-3b978df8b753")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("EX3.EditStartCommand")]
    public sealed class EditStartCommand : BaseCommand
    {
        ...
        public EditStartCommand(AxMapControl ax,IFeatureLayer editingFeature,IWorkspaceEdit _edit,Form1 partent)
        {
            _ax = ax;
