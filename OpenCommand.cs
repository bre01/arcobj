...
namespace EX3
{
    ...
    /// </summary>
    [Guid("475273b5-924a-4be5-a2fd-0a3804b186a6")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("EX3.OpenCommand")]
    public sealed class OpenCommand : BaseCommand
    {
        ...
        public OpenCommand()
        {
            ...
            base.m_caption = "Open database or other workspace";  //localizable text
        ...
        public override void OnClick()
        {
            ...
            IMapControl3 mapControl = (IMapControl3)HookTool.GetMapControl(m_hookHelper);
            var log = new LoadLayerDlg(mapControl);
            log.ShowDialog();
